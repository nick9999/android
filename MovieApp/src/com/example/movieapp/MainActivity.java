...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        searchEditText.setOnFocusChangeListener(new DftTextOnFocusListener(getString(R.string.action_settings)));
    ...
    private void findAllViewsById() {
        searchEditText = (EditText) findViewById(R.id.action_settings);
        moviesSearchRadioButton = (RadioButton) findViewById(R.id.action_settings);
        peopleSearchRadioButton = (RadioButton) findViewById(R.id.action_settings);
        searchRadioGroup = (RadioGroup) findViewById(R.id.action_settings);
        searchTypeTextView = (TextView) findViewById(R.id.action_settings);
        searchButton = (Button) findViewById(R.id.action_settings);
    }
